...
const Footer = () => {
    return (
        <>
            <footer className="footer footer-center p-10 bg-primary text-primary-content mt-4">
                <div>
                    ...
                    <p className="font-bold">
                        Good Food Ltd. <br />Providing reliable tech since 2004
                    </p>
                    <p>Copyright © 2023 - All right reserved by Provider</p>
                </div>
                <div>
