                        ...
                        <div key={id} className="flex flex-col items-center justify-center w-full max-w-sm mx-auto px-2 my-4">
                            ...
                            <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                                ...
                                <div className="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700">
                                    ...
                                    <Link to={`/food/${data.id}`} className="px-4 py-4 text-xs font-semibold text-white uppercase transition-colors duration-300 transform bg-gray-800 rounded hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none">See Details</Link>
                                </div>
                            </div>
                        </div>
                    )
